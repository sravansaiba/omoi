      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <form className="mb-6">
          ...
          <div
            ...
            <input
              ...
              style={{
                background: mode === 'dark'
                  ? '#353b48'
                  : 'rgb(226, 232, 240)',color:mode==='dark'?'white':'black'
              }}
            />
          </div>
          ...
          >
            ...
            id="comment" rows={6} className="px-0 w-full text-sm border-0 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400 " style={{ background: mode === 'dark' ? '#353b48' : 'rgb(226, 232, 240)',color:mode==='dark'?'white':'black' }} placeholder="Write a comment..." required defaultValue={""} />
          </div>
          {/* Button  */}
          <div className="">
          <Button 
        ...
        <article className="p-6 mb-6 text-base rounded-lg " style={{ background: mode === 'dark' ? '#353b48' : 'rgb(226, 232, 240)' }}>
          {allComment.map((item,idx)=>{
            ...
            return(
              <>
              <footer className="flex justify-between items-center mb-" key={idx}>
